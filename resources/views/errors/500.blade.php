...
@section('content')
    <div class="text-center p-8 bg-white rounded-2xl shadow-xl max-w-md w-full mx-4 border border-gray-100">
        <h1 class="text-8xl font-black text-blue-600 tracking-tighter mb-4">500</h1>
        <h3 class="text-2xl font-bold text-gray-800 mb-3 flex items-center justify-center gap-2">
            <i class="fas fa-exclamation-triangle text-orange-500"></i> Internal Server Error
        </h3>
        <p class="text-gray-600 mb-8">You do not have permission to view this resource</p>
