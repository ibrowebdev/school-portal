...
@section('content')
    <div class="text-center p-8 bg-white rounded-2xl shadow-xl max-w-md w-full mx-4 border border-gray-100">
        <h1 class="text-8xl font-black text-blue-600 tracking-tighter mb-4">419</h1>
        <h3 class="text-2xl font-bold text-gray-800 mb-3 flex items-center justify-center gap-2">
            <i class="fas fa-exclamation-triangle text-orange-500"></i> Page Expired
        </h3>
        <p class="text-gray-600 mb-8">The page you requested has expired.</p>
