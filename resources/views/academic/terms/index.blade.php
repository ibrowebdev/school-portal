...
<div class="modal custom-modal fade" id="deleteTerm" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-xl border-0 shadow-lg">
            <div class="modal-body p-6 text-center">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Delete Term</h3>
                <p class="text-gray-500">Are you sure?</p>
                <form id="deleteTermForm" method="POST" class="x-submit mt-4" data-then="reload">
                    @csrf
                    @method('DELETE')
