        ...
        <div class="md:col-span-4 lg:col-span-3">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <ul class="flex flex-col py-2">
                    ...
                    <li>
                        <a href="{{ route('invoice/settings/tax/page') }}" class="flex items-center gap-3 px-6 py-3 text-sm font-medium text-blue-600 bg-blue-50 border-r-4 border-blue-600 transition-colors">
            ...
            <x-card title="Tax Settings">
                ...
                <form action="#" class="x-submit space-y-6" data-then="reload">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 items-center">
                        <label class="text-sm font-medium text-gray-700 md:text-right">Enable Tax</label>
                        <div class="md:col-span-2">
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="invoice" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="text-sm text-gray-600">Check to enable tax on invoice</span>
                            </label>
                        </div>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 items-center">
                        <label class="text-sm font-medium text-gray-700 md:text-right">Tax Percentage</label>
                        <div class="md:col-span-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 items-center">
                        <label class="text-sm font-medium text-gray-700 md:text-right">GSTIN Number</label>
                        <div class="md:col-span-2">
                            <input type="text" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                    </div>
