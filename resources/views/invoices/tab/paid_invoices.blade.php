...
<div class="space-y-6">
    ...
    <div class="flex justify-end gap-2 mb-4">
        <a href="{{ route('invoice/paid/page') }}" class="w-10 h-10 rounded-lg flex items-center justify-center transition-colors bg-blue-600 text-white shadow-sm">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="overflow-x-auto w-full md:w-auto pb-2 md:pb-0 hide-scrollbar">
                <ul class="flex items-center space-x-1 px-2 min-w-max">
                    ...
                    <li><a href="{{ route('invoice/paid/page') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium whitespace-nowrap">Paid</a></li>
