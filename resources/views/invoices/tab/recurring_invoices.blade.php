...
<div class="space-y-6">
    ...
    <div class="flex justify-end gap-2 mb-4">
        <a href="{{ route('invoice/recurring/page') }}" class="w-10 h-10 rounded-lg flex items-center justify-center transition-colors bg-blue-600 text-white shadow-sm">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="overflow-x-auto w-full md:w-auto pb-2 md:pb-0 hide-scrollbar">
                <ul class="flex items-center space-x-1 px-2 min-w-max">
                    ...
                    <li><a href="{{ route('invoice/recurring/page') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium whitespace-nowrap">Recurring</a></li>
            ...
            <table class="w-full text-sm text-left datatable">
                <thead class="bg-gray-50 text-gray-600 font-medium border-b border-gray-100">
                    <tr>
                        ...
                        <th class="px-4 py-4">Last invoice</th>
                        <th class="px-4 py-4">Next invoice</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-4 text-gray-600 whitespace-nowrap">28 Mar 2022</td>
                        <td class="px-4 py-4 text-gray-600 whitespace-nowrap">14 Months</td>
                        <td class="px-4 py-4">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-4 text-gray-600 whitespace-nowrap">12 Months</td>
                        <td class="px-4 py-4">
                            <span class="px-3 py-1 bg-red-100 text-red-700 rounded-full text-xs font-medium">Expired</span>
                        </td>
                        <td class="px-4 py-4 text-right whitespace-nowrap">
                            <a href="edit-invoice.html" class="inline-flex items-center gap-1 px-3 py-1.5 bg-white border border-gray-200 text-emerald-600 rounded-lg hover:bg-emerald-50 transition-colors">
                                <i class="far fa-edit"></i> Edit
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-4 text-gray-600 whitespace-nowrap">18 Mar 2022</td>
                        <td class="px-4 py-4 text-gray-600 whitespace-nowrap">08 Months</td>
                        <td class="px-4 py-4">
                            <span class="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs font-medium">Active</span>
                        </td>
                        <td class="px-4 py-4 text-right whitespace-nowrap">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-4 text-gray-600 whitespace-nowrap">15 Mar 2022</td>
                        <td class="px-4 py-4 text-gray-600 whitespace-nowrap">22 Mar 2022</td>
                        <td class="px-4 py-4 text-gray-600 whitespace-nowrap">10 Months</td>
                        <td class="px-4 py-4">
                            <span class="px-3 py-1 bg-red-100 text-red-700 rounded-full text-xs font-medium">Expired</span>
                        </td>
                        <td class="px-4 py-4 text-right whitespace-nowrap">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-4 text-gray-600 whitespace-nowrap">20 Mar 2022</td>
                        <td class="px-4 py-4 text-gray-600 whitespace-nowrap">31 Mar 2022</td>
                        <td class="px-4 py-4 text-gray-600 whitespace-nowrap">03 Months</td>
                        <td class="px-4 py-4">
                            <span class="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs font-medium">Active</span>
                        </td>
                        <td class="px-4 py-4 text-right whitespace-nowrap">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-xl border-0 shadow-lg">
                <div class="p-6 text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-2">Delete Invoice Recurring</h3>
