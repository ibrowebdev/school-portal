...
<div class="space-y-6">
    ...
    <div class="flex justify-end gap-2 mb-4">
        <a href="{{ route('invoice/draft/page') }}" class="w-10 h-10 rounded-lg flex items-center justify-center transition-colors bg-blue-600 text-white shadow-sm">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="overflow-x-auto w-full md:w-auto pb-2 md:pb-0 hide-scrollbar">
                <ul class="flex items-center space-x-1 px-2 min-w-max">
                    ...
                    <li><a href="{{ route('invoice/draft/page') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium whitespace-nowrap">Draft</a></li>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-xl border-0 shadow-lg">
                <div class="p-6 text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-2">Delete Invoice Draft</h3>
